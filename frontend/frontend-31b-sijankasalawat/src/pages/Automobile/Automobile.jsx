      ...
      <div className="all-product container pt-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 md:grid-col-3">
          {displayedProducts.map((product) => {
            return (
              <Link key={product._id} to={`/productDetail/${product._id}`} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-3 hover:shadow-xl overflow-hidden">
                ...
                <div className="p-5">
                  <h2 className="mb-2 text-sm lg:text-2xl md:text-xl font-bold text-gray-900">{product.brandName}</h2>
